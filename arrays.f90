...
!    Real*8, dimension(:,:), allocatable :: Bisp
    Double Complex, dimension(:), allocatable :: fkG,fkNG!,GaussianField, NGField, fkNG!,alphak!, calphak
    ...
    Double Complex, dimension(:,:), allocatable :: All_alphak,GaussianField,NGField
