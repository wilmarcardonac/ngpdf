...
Real*8,parameter :: fNL = 0.d0!2.d-1 ! 5.d-1 ! 1.d0 ! Non-Gaussianity parameter for the quadratic mapping. Matsubara uses three cited values
...
Integer*4,parameter :: number_of_realizations = 1d3 ! number of realizations of field
